...
class MYPROJECTDEMO1_API UPathTracerComponent : public UActorComponent
{
	GENERATED_BODY()
...
private:
	...
	void SetupPathSegments(FVector Start_P, FVector End_P, bool IsSegmentStraight_P, FVector StartTangent_P, FVector EndTangent_P);
	void SetSegmentsDotted(FVector Start_P, FVector End_P, bool IsSegmentStraight_P, FVector StartTangent_P, FVector EndTangent_P);
